...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.tabBar.selectedImageTintColor = RGBColor(182, 65, 65, 1);
...
- (NSArray *)mpViewControllers {
    ...
    BaseNavgationController *firstNavigationController = [[BaseNavgationController alloc]
                                                         initWithRootViewController:firstViewController];
    
    SecondViewController *secondViewController = [[SecondViewController alloc] init];
    BaseNavgationController *secondNavigationController = [[BaseNavgationController alloc]
                                                          initWithRootViewController:secondViewController];
    
    ThirdViewController *thirdViewController = [[ThirdViewController alloc] init];
    BaseNavgationController *thirdNavigationController = [[BaseNavgationController alloc]
                                                         initWithRootViewController:thirdViewController];
    
    ForthViewController *fourthViewController = [[ForthViewController alloc] init];
    BaseNavgationController *fourthNavigationController = [[BaseNavgationController alloc]
